            ...
            <div className='container'> 
                ...
                <div className='col-6'>                    
                    ...
                    <div className='form-group'>
                        ...
                        <input type='text' name='UserName' className='form-control' onBlur={this.onCheckUserName.bind(this)} value={this.state.UserName} onChange={this.onChangeUser.bind(this)} />
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td> <input type='button' value='Add User' className='btn btn-default btn-success' onClick={this.onClickCreateUser.bind(this)} /></td>
                                    <td> <input type='button' value='Update User' className='btn btn-default btn-success' onClick={this.onClickUpdateUser.bind(this)} /></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    render(){
        return(
            <tr onClick={this.onRowClick.bind(this)}>
                ...
                <td>{this.props.row.IsApproved}</td>                              
            </tr>
        )
    }
}
